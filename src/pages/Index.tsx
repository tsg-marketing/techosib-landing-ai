...
const models: Model[] = [
  {
    ...
    videoUrl: "https://rutube.ru/play/embed/3d5b579103f00442bcbcf94e1a75a079/",
    features: [
      "Размеры паллет 800×1200 мм и 1000×1200 мм",
      "Высота паллет до 2400 мм",
      "Вес паллет до 2000 кг",
      "Привод каретки поворотного стола – цепной",
  ...
  },
  {
    ...
    videoUrl: "https://rutube.ru/play/embed/36ca1c58ba9d91e41a902101aefb239a/",
    features: [
      "Размеры паллет 800×1200 мм и 1000×1200 мм",
      "Высота паллет до 2400 мм",
      "Вес паллет до 2000 кг",
    ...
    detailedSpecs: {
      ...
      turntableRotationSpeed: "Регулируемая",
      turntableDrive: "Цепной",
      preStretch: "Фиксированный 250%",
      carriageDrive: "Цепной",
      filmTension: "Регулируемое с панели управления",
      turntableHeight: "78-80 мм",
      turntableDiameter: "1650 мм",
      maxPalletSize: "1000×1200 мм",
      maxPalletHeight: "2400 мм",
  ...
  },
  {
    ...
    videoUrl: "https://rutube.ru/play/embed/99fd63779b6594febf9ef7f5d40b0dd4/",
    features: [
      "Размеры паллет 800×1200 мм и 1000×1200 мм",
      "Высота паллет до 2400 мм",
      "Вес паллет до 2000 кг",
  ...
  },
  {
    ...
    videoUrl: "https://rutube.ru/play/embed/70daaca34940ea89ab0bc4578ad55d41/",
    features: [
      "Размеры паллет 800×1200 мм и 1000×1200 мм",
      "Высота паллет до 2400 мм",
      "Вес паллет до 800 кг",
  ...
  },
  {
    ...
    detailedSpecs: {
      brand: "ТЕХНОСИБ",
      weight: "500 кг (нетто), 520 кг (брутто)",
      installedPower: "950 Вт",
      turntableRotationSpeed: "—",
      turntableDrive: "—",
      preStretch: "Фиксированный 250%",
      carriageDrive: "Двигатель подъема каретки 300 Вт",
      filmTension: "Регулируемое",
      turntableHeight: "—",
      turntableDiameter: "—",
      maxPalletSize: "Без ограничений",
      maxPalletHeight: "2400 мм (стандарт); 2800/3100/3200 мм (опция)",
      smoothStartStop: "—",
      carriageSpeed: "До 90 м/мин",
      maxFilmRollDiameter: "До 250 мм",
      filmCoreDiameter: "75 мм",
      filmWidthThickness: "500 мм",
      topCoverCycle: "—",
      filmBreakSignal: "—",
      programsCount: "—",
      separateWrapsAdjustment: "—",
      heightDetection: "—",
      heightWrapping: "Да",
      forkliftCompatibility: "—",
      controlPanel: "Панель управления",
      power: "220 В, АКБ 12V 110Ah (2 шт)",
      dimensions: "Минимальный размер паллета: 600×600×500 мм",
      maxCapacity: "Без ограничений"
    },
    images: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
              {/* Header */}
              <div className="bg-gradient-to-r from-orange-500 to-orange-400 px-8 py-6 flex items-center gap-5">
                <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md">
                  <Icon name="Gift" size={36} className="text-orange-500" />
                </div>
                <div>
                  <div className="text-white/80 text-sm font-semibold uppercase tracking-widest mb-1">Специальное предложение</div>
                  <h2 className="text-2xl md:text-3xl font-black text-white leading-tight">Акция от компании «Техно-Сиб»</h2>
                </div>
              </div>
              {/* Content side */}
